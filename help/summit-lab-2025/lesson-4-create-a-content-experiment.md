...
Voir [Expérimentation - Présentation](/help/content-management/experimentation-overview.md), [Configurer des expériences de contenu pour des campagnes par e-mail](/help/create-campaigns/content-experiments.md) et [Notifications push - Présentation](/help/channels/push-notifications-overview.md) pour plus d’informations sur cette rubrique.

...
description: Découvrez comment créer des applications monopages (SPA) dans l’éditeur web de Journey Optimizer.
feature: Web Channel
role: Developer
level: Intermediate
...
Découvrez comment créer des applications monopages (SPA) dans l’éditeur web de Journey Optimizer.

---
title: Accélérer les tests de Parcours avec la simulation rapide
description: Découvrez comment la simulation rapide permet de tester efficacement les parcours client avant de les publier.
role: User
level: Beginner
...
# Accélérer les tests de parcours avec la simulation rapide

...
description: Comprendre les cas d’utilisation
feature: Overview
role: User
...
| Exemple d’utilisation | Description | Exemple de cas d’utilisation |
|---------|-------------|----------------------|
...
| **Campagne de montée en gamme et de ventes croisées** | Promeut des produits supplémentaires ou des mises à niveau pour les clients existants en fonction de leur comportement, de leurs préférences ou de leur historique d’achat. | Stimuler le réabonnement et la croissance du chiffre d’affaires |

...
### Composants Mobile SDK requis pour les cas d’utilisation mobiles Journey Optimizer

Pour utiliser les canaux mobiles Journey Optimizer (notifications push, in-app, cartes de contenu, expériences basées sur du code), vous devez installer et configurer les extensions suivantes :

![Extensions requises](/help/mobile-learning-hub/assets/extensions.png)

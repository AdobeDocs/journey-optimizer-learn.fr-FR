...
description: Tirez parti du type de contenu JSON dans Adobe Journey Optimizer (AJO) pour créer des expériences de personnalisation flexibles et basées sur les données.
feature: Decisioning
role: User
level: Beginner
doc-type: Tutorial

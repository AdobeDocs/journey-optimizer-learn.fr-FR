...
>[!VIDEO](https://video.tv.adobe.com/v/3430274?captions=fre_fr&quality=12&learn=on){transcript=true}

Pour plus d’informations sur [la configuration d’une action personnalisée](https://experienceleague.adobe.com/fr/docs/journey-optimizer/using/configuration/configure-journeys/action-journeys/about-custom-action-configuration){target="_blank"}, consultez la documentation du produit.

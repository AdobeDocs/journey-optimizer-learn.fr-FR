...
description: Découvrez comment les rapports Adobe Journey Optimizer (AJO) vous permettent de suivre, d’analyser et d’agir facilement sur les parcours clients. Ces tutoriels donnent aux spécialistes marketing et aux analystes les outils nécessaires pour surveiller les performances en temps réel, explorer en détail les informations sur les parcours et les canaux, exporter des données, définir des alertes et utiliser des analyses avancées pour prendre des décisions plus intelligentes.
feature: Reporting
role: User
...
<div class="columns">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/report-and-monitor/introduction-to-reporting" target="_blank" rel="referrer" title="Présentation de la création de rapports dans Adobe Journey Optimizer (AJO)">Présentation de la création de rapports dans Adobe Journey Optimizer (AJO)</a>
                    </p>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Analyze your journey's overall performance with all time reports">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/report-and-monitor/all-time-reports" title="Analysez les performances globales de votre parcours avec les rapports complets." target="_blank" rel="referrer">
                        <img class="is-bordered-r-small" src="https://video.tv.adobe.com/v/3475789/?captions=fre_fr&format=jpeg&nocache=1764706279437" alt="Analysez les performances globales de votre parcours avec les rapports complets."
                             style="width: 100%; aspect-ratio: 16 / 9; object-fit: cover; overflow: hidden; display: block; margin: auto;">
                    </a>
                </figure>
            </div>
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="https://experienceleague.adobe.com/fr/docs/journey-optimizer-learn/tutorials/report-and-monitor/all-time-reports" target="_blank" rel="referrer" title="Analysez les performances globales de votre parcours avec les rapports complets.">Analyser les performances globales de votre parcours avec les rapports complets</a>
                    </p>

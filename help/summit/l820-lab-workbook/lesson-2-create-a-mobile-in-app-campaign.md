...
1. Ouvrez [Adobe Journey Optimizer](https://experience.adobe.com/#/@techmarketingdemos/sname:summit-ajo-lab/journey-optimizer/home){target="_blank"}
...
3. Vous pouvez ignorer les deux écrans suivants :
   ...
   <br>
   ![Fenêtre contextuelle Personalization](/help/summit/l820-lab-workbook/assets/2-1-4-ajo-personalization-pop-up.png)
...
1. Dans la liste déroulante **[!UICONTROL App surface]**, sélectionnez **[!DNL Frecopa Mobile App]**.
...
>
> ![Propriétés de campagne](/help/summit/l820-lab-workbook/assets/3-1-1-2-campaign-properties.png)
...
L’éditeur [!UICONTROL Message in-app] s’affiche, dans lequel vous configurez le contenu du message in-app.
...
2. Dans la section **[!UICONTROL Contenu]** suivante, ajoutez votre propre texte personnalisé que vous souhaitez afficher dans votre message pour les **[!UICONTROL En-tête]** et **[!UICONTROL Corps]**.
...
3. Options supplémentaires :
   1. **Boutons :**
      ...
      2. Le champ **[!UICONTROL Interact event]** permet de définir la valeur transmise au SDK lorsque l’utilisateur appuie sur l’CTA.

      3. Le champ **[!UICONTROL Target]** est utilisé pour définir l’emplacement où vous souhaitez que l’CTA emmène l’utilisateur. Cela inclut les URL et les liens profonds. Par exemple, vous pouvez ajouter ce lien profond à une page de produit telle que `dxdemo://exoticVibes`.

      4. Vous pouvez ajouter d’autres boutons en appuyant sur **[!UICONTROL + Ajouter un bouton]**.
   ...
   2. **Formatage avancé**
      ...
      ![options de formatage avancées](/help/summit/l820-lab-workbook/assets/3-1-3-2-advanced-formatting-options.png)

   3. **Onglet Paramètres**

      En passant le pointeur de la souris sur cet onglet et dans la section **[!UICONTROL Aperçu]**, vous pouvez modifier l’ **Aperçu de l’application**.
      <br>\
      ![Onglet Paramètres](/help/summit/l820-lab-workbook/assets/3-1-3-1-settings-tab.png)
      <br>

      1. La section **[!UICONTROL Mise en page]** vous permet d’utiliser une image comme arrière-plan ou couleur uni.
...
4. Lorsque vous avez terminé de créer votre contenu et que vous êtes satisfait de votre message, cliquez sur le bouton **[!UICONTROL Réviser pour activer]** .
   ...
   >[!SUCCESS]
   >
   > Vous avez maintenant terminé de créer votre message in-app mobile. Vous devriez maintenant être sur la page Campaign **[!UICONTROL Réviser pour activer]** .
   >
   ...
   >
   > *Notez la valeur personnalisée que vous avez utilisée comme règle de déclenchement. Cette valeur sera utilisée pour déclencher votre message in-app. La valeur utilisée se trouve dans la zone de surbrillance de la page de résumé.*

   >[!NOTE]
   >Le déclencheur actuel du message in-app est l’événement de lancement d’application par défaut **qui se produit**, ce qui signifie que le message in-app est déclenché au lancement de l’application. Vous pouvez le voir dans la **[!UICONTROL section Planning]**.
...
>[!SUCCESS]
>
> Le tableau de bord Campagnes devrait maintenant s’afficher. Localisez votre campagne à l’aide du défilement ou de la fonction de recherche. Lorsque votre campagne passe à l’état **[!UICONTROL Live]** (~1min), votre campagne est maintenant publiée.
>
...
3. Accédez maintenant à l’onglet Exercice de l’application.
   ...
   ![Bouton Exercise](/help/summit/l820-lab-workbook/assets/3-2-3-app-exercise-button.png)
...
>
> *Si vous rencontrez des problèmes pour déclencher votre message, vérifiez les éléments suivants :*
> 
...
> * *Assurez-vous que la casse est correcte et que vous ne disposez pas d&#39;espace de début ou de fin.*
> * *Vous pouvez rechercher la valeur de la règle de déclenchement que vous avez utilisée si vous revenez à la page de révision de Campaign en cliquant à nouveau sur votre campagne dans le tableau de bord de Campaign.*
...
Les fonctionnalités **Dupliquer la campagne** et **Aperçu sur l’appareil** sont une fonctionnalité prête à l’emploi qui vous permet de dupliquer vos campagnes et de tester et de revoir vos messages In-App directement sur votre appareil avant de l’activer. Dans cet exercice, vous apprendrez à utiliser cette fonctionnalité et à prévisualiser le message que vous avez créé dans l’exercice 3.1.

1. Ouvrez l&#39;opération que vous venez de créer, en cliquant sur son nom dans le tableau de bord Campagnes pour l&#39;ouvrir. Cela vous ramène à la page **[!UICONTROL Réviser la campagne]**.
1. Appuyez sur le bouton **[!UICONTROL Dupliquer]**. Une nouvelle invite s’affiche alors pour nommer la nouvelle campagne qui est dupliquée. Ajoutez un nouveau nom que vous mémorisez facilement ou utilisez le nom par défaut où **[!DNL _copy]** est ajouté par défaut.

   ![duplication de campagne](/help/summit/l820-lab-workbook/assets/3-2-duplicate-campaign.png)
...
1. Vous pouvez accéder à la fonction Aperçu sur l’appareil sur la page **[!UICONTROL Révision de campagne]** ou sur l’étape **[!UICONTROL Auteur de campagne]** .

   ![aperçu sur le bouton de périphérique](/help/summit/l820-lab-workbook/assets/3-3-1-1-preview-on-device-button.png)
   <br>

1. Cliquez ensuite sur le bouton **[!UICONTROL démarrer]** de l’écran de connexion à l’appareil.
...
>
> *Une fois connecté, votre message in-app doit s’afficher à chaque fois, vous cliquez sur le bouton **[!UICONTROL Aperçu sur l’appareil]**.
...
* [Créer un message Mobile In-App](https://experienceleague.adobe.com/fr/docs/journey-optimizer/using/in-app/create-in-app)

...
+ Gestion de contenu{#content-management}
   ...
   + Gérer les ressources {#assets}
      ...
      + [Gérer les ressources](/help/content-management/assets-essentials-overview.md)
...
+ Cas d’utilisation et meilleures pratiques{#use-cases}
   ...
   + [Évolution de l’orchestration à l’engagement omnicanal](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/tutorials/exercises-and-challenges/summit-labs/introduction){target="_blank"}
...
+ Exercices, labos et défis {#exercises-and-challenges}
   ...
   + Summit Labs {#summit-labs}
      ...
      + [Évolution de l’orchestration vers l’engagement omnicanal dans Adobe Journey Optimizer (2025)](https://experienceleague.adobe.com/en/docs/journey-optimizer-learn/scaling-orchestration-to-omnichannel-engagement/introduction.md){target="_blank"}

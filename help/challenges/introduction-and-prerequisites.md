...
* Le [les canaux de messagerie doivent être configurés.](https://experienceleague.adobe.com/docs/journey-optimizer/using/configuration/channel-surfaces.html) pour les messages transactionnels et marketing.

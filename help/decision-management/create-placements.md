...
description: Découvrez comment créer des emplacements pour la gestion de décision. Les emplacements sont l’un des composants de base requis des offres.
feature: Offers
kt: 6736
...
Découvrez comment créer [emplacements](https://experienceleague.adobe.com/docs/journey-optimizer/using/offer-decisioniong/create-components/creating-placements.html?lang=fr) pour la gestion des décisions. Les emplacements sont l’un des composants de base des offres.

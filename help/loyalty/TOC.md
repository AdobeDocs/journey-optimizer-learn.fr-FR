...
+ {hide-from-toc}[Comprendre les concepts du défi de fidélité](./introduction-to-loyalty/understand-loyalty-challenge-concepts.md)
...
+ Configurer votre défi {#configure-your-challenge}
  ...
  + [Créez des défis et obtenez des informations avec l’agent Loyalty AI](./configure-your-challenge/create-a-challenge-and-get-insights-with-cx-enterprise-coworker.md)
...
+ Analyse et rapport {#analyze-and-report}
  ...
  + [Analysez les performances de la fidélité à l’aide du tableau de bord des informations de fidélité.](./analyze-and-report/analyze-loyalty-performance-using-loyalty-insights-dashboard.md)
